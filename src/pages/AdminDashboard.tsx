...
import { LogOut, Shield, Tag, Calendar, ListChecks, QrCode, User, Menu, Settings, BarChart, Home, Mail } from 'lucide-react';
...
import EmailTemplatesPage from '@/components/admin/EmailTemplatesPage'; // Import new page
          ...
          <div className="md:hidden self-end">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="bg-black/90 border-purple-500/30 backdrop-blur-sm text-white">
                ...
                <DropdownMenuItem asChild>
                  <Link to="/admin/dashboard?tab=email" className="flex items-center">
        ...
        <div className="bg-black/30 border border-purple-500/30 rounded-xl p-4 md:p-6 shadow-2xl backdrop-blur-sm">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsList className="grid w-full grid-cols-6 bg-gray-800/50 border border-gray-700/50 h-auto p-1">
              ...
              <TabsTrigger value="email" className="data-[state=active]:bg-purple-600/50 data-[state=active]:text-white data-[state=active]:border-b-2 data-[state=active]:border-purple-400 py-2 text-sm md:text-base">
                <Mail className="h-4 w-4 mr-1 md:mr-2" /> <span className="hidden sm:inline">Email</span>
              </TabsTrigger>
