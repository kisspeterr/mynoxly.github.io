        ...
        <div className="container mx-auto">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="max-w-4xl mx-auto">
            <TabsList className="grid w-full grid-cols-3 bg-slate-800/50">
              <TabsTrigger value="events" className="data-[state=active]:bg-cyan-500 data-[state=active]:text-white">
                <Calendar className="h-4 w-4 mr-2" />
                Események
              </TabsTrigger>
              <TabsTrigger value="deals" className="data-[state=active]:bg-purple-500 data-[state=active]:text-white">
                <Ticket className="h-4 w-4 mr-2" />
                Akciók
              </TabsTrigger>
              <TabsTrigger value="map" className="data-[state=active]:bg-pink-500 data-[state=active]:text-white">
            ...
            <TabsContent value="events" className="mt-6">
              <Card className="bg-slate-800/50 border-cyan-500/20">
                <CardHeader>
                  ...
                  <CardDescription>Fedezd fel a legfrissebb programokat Pécsen</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {[1, 2, 3].map((item) => (
                      <div key={item} className="flex items-center justify-between p-4 bg-slate-700/50 rounded-lg hover:bg-slate-700/70 transition-colors">
                        <div>
                          <div className="font-semibold">Pécsi Koncert Est {item}</div>
            ...
            <TabsContent value="deals" className="mt-6">
              <Card className="bg-slate-800/50 border-purple-500/20">
                <CardHeader>
                  <CardTitle>Friss Akciók</CardTitle>
                  <CardDescription>Spórolj a kedvenc helyeiden</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-2">
                    {[1, 2].map((item) => (
                      <Card key={item} className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 border-purple-500/30">
                        <CardHeader>
                          <Badge className="w-fit bg-green-500">-30%</Badge>
                          <CardTitle>1+1 Italakció</CardTitle>
                          <CardDescription>Kedvenc bárodban</CardDescription>
                        </CardHeader>
                        <CardContent>
                          <Progress value={70} className="mb-2" />
                          <div className="text-sm text-gray-400">70% felhasználva</div>
                        </CardContent>
                      </Card>
                    ))}
                  </div>
            ...
            <TabsContent value="map" className="mt-6">
              <Card className="bg-slate-800/50 border-pink-500/20">
                <CardHeader>
                  <CardTitle>Élő Térkép</CardTitle>
                  <CardDescription>Fedezd fel Pécs legjobb helyeit</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="aspect-video bg-gradient-to-br from-cyan-600/20 to-purple-600/20 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-gray-300">Interaktív térkép betöltése...</p>
