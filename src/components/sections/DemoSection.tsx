    ...
    <section id="demo-section" className="py-20 px-6">
      <div className="container mx-auto">
        ...
        <div className="max-w-md mx-auto">
          <Card className="bg-gradient-to-br from-cyan-950/50 via-purple-950/40 to-blue-950/50 border-cyan-500/30 backdrop-blur-sm hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500">
